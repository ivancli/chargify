...
class ProductFamilyController
{
    ...
    public function all()
    {
        if (config('chargify.caching.enable') == true) {
            return Cache::remember("product_families", config('chargify.caching.ttl'), function () {
                return $this->__all();
            });
        } else {
            return $this->__all();
    ...
    {
        if (config('chargify.caching.enable') == true) {
            return Cache::remember("product_families.{$product_family_id}", config('chargify.caching.ttl'), function () use ($product_family_id) {
